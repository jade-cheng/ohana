...
namespace
{
    ...
    {
        queue_type out;
        out.push({ +0.200000e+00, -2.586994e+00, -2.372868e+00 });
        out.push({ -3.333333e-01, -3.285576e+00, -2.829367e+00 });
        out.push({ -3.333333e-01, -4.491654e+00, -4.029706e+00 });
        out.push({ -1.000000e+00, -7.556465e+00, -2.276189e+00 });
        return out;
    }();
    ...
    {
        queue_type out;
        out.push({ -1.000000e+00, -3.969019e-01, -2.000001e-06 });
        out.push({ -1.000000e+00, -8.615658e-01, -8.615658e-01 });
        out.push({ -2.666667e-01, -3.054189e+00, -2.648970e+00 });
        out.push({ -1.000000e+00, -3.028255e+00, -2.000001e-06 });
        return out;
    }();
